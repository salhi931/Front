...
export class EditArticleComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    console.log(this.gestionDesArticlesService.article_consulter);
    this.test = this.gestionDesArticlesService.article_consulter.famille;
    console.log(this.gestionDesArticlesService.article_consulter.famille);
  }
  ajouterimages(): any{
    this.openDialog();
  }
  ...
  onSubmit(f: NgForm): any{
    ...
    this.gestionDesArticlesService.modifier( this.gestionDesArticlesService.nouveauSelectedfile, this.gestionDesArticlesService.imagesSupprimer);
  }
  ngOnDestroy(): void {
